...
file_to_load = os.path.join("Resources", "electionResults.csv")
...
with open(file_to_save,"w")as txt_file:
    ...
    # 3. Calculate the percentage of votes.
        ...
        #print each candidate results to our text file. 
    ...
    #Save the candidate results to our text file.
        ...
        #If true then set winning_count= votesand winning_percent=
        #vote_percentage. 
            winning_count=votes
